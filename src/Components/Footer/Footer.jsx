...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-purple-900 via-purple-800 to-purple-900 text-white relative overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <img src="/src/assets/logo.png" alt="Vitus Logo" className="h-10 w-auto" />
              <span className="text-2xl font-bold">ویتوس</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/topproducts" className="text-gray-300 hover:text-white transition-colors">محصولات</Link></li>
              <li><Link to="/aboutme" className="text-gray-300 hover:text-white transition-colors">درباره ما</Link></li>
              <li><Link to="/contactme" className="text-gray-300 hover:text-white transition-colors">تماس</Link></li>
            </ul>
          </div>
