...
const ProductsData = [
  {
    ...
    color: "white",
    aosDelay: "400",
    description: "لورم ایپسوم  استفاده از طراحان گرافیک است",
  },
  {
    id: 2,
    img: Img2,
          ...
          {ProductsData.map((data) => (
            ...
            >
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-gary-500 mt-2 group-hover:text-white duration-300 text-xs text-center line-clamp-2">
                  {data.description}
                </p>
